...
Kiểm định $\psi$ là ở mức $\alpha\in(0,1)$ nếu có xác suất lỗi loại 1
...
Từ dữ liệu quan sát $X_1, \ldots, X_n$ ta tính giá trị mức $\alpha$
...
| p-value | phân lớp độ mạnh của chứng cứ
| --------| --------
| $<1\%$  | chứng cứ rất mạnh phủ nhận $H_0$
| $1\%\textemdash 5\%$  | chứng cứ mạnh phủ nhận $H_0$
| $5\%\textemdash 10\%$ | chứng cứ yếu ớt phủ nhận $H_0$
| $>10\%$ | không phải chứng cứ phủ nhận $H_0$
