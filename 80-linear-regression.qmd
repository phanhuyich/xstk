...
Tìm tham số $\vec{\beta}\in\R^p$ cho mô hình
$$
Y = \X^\tp\vec{\beta} + \epsilon,
$$
Ta có $n$ samples, $p$ covariates:
$$
Y_i = \X_i^\tp\vec{\beta} + \epsilon_i, i=1,\ldots,n,
$$
