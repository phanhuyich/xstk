...
$$
S_n^2 \is\frac{\sum_{i=1}^{n}(X_i-\bar{X}_n)^2}{n-1}.
$$
Ta có $\E{S_n^2}\equiv\V{X}.$
:::
:::{.remark}
Định lý Cochoran @thm-cochoran.
:::
...
### Tích suất mẫu
Từ các quan sát
$X_1,\ldots X_n\iid \P_\theta, \theta\in\Theta\subset\R^d.$
Để ước lượng tích suất
$\E{X^k}$
ta có thể dùng các *sample moment*:
$$
