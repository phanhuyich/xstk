...
Tích suất hạng $n$ của biến ngẫu nhiên $X$
với mật độ $f(x)$ là:
...
::: {#def-expectation}
### Trung bình
là tích suất hạng 1, tức là $\E[X]$.
:::
...
Ta có
$$
\textrm{Cov}[X,Y] \equiv \E[XY] - \E[X]\E[Y],
$$
$$
...
$$X_1,\ldots,X_n \stackrel{iid}{\sim } X.$$
:::
...
$X_1,\ldots,X_n \stackrel{iid}{\sim } \Ber(p).$
Ta có
$$
